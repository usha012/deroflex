                    ...
                    <ul class="sub-menu product_sub_menu commn_sub_menu_height px-2 pb-3">
                        <div class="container">
                            <div class="micro_menu row mx-0 d-flex">
                                <div class="micro_menu_li w-auto "  onclick='window.open("./new_products/Flexible_Pipe_System/FlexiblePipeSystem.html");'>
                                ...
                                <div class="micro_menu_li w-auto" onclick='window.open("./new_products/Vibration_Isolation/Vibration_Isolation.html");'>
                                ...
                                <div class="micro_menu_li  w-auto" onclick='window.open("./new_products/Mechanical_Seal/Mechanical_Seal.html");'>
                                ...
                                <div class="micro_menu_li  w-auto" onclick='window.open("./new_products/Flexible_Hose/Flexible_Hose.html");'>
                                    <li class="micro_menu_li_head"><a href="project-grid.html" >Flexible Hose </a></li>                                        
                                    <li><a href="">Stainless Steel Hose   </a></li>
                                ...
                                <div class="micro_menu_li w-auto" onclick='window.open("./new_products/Customized/Customized.html");'>
                                    <li class="micro_menu_li_head"><a href="project-grid.html" >Customized</a></li>                                        
                                    <li><a href="">Piston Seal  </a></li>
